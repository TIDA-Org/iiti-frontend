...
function getMockData(path: string): unknown {
  ...
  const mockResponses: Record<string, unknown> = {
    ...
    '/website/certificates': {
      ...
      title_highlight: 'Graduation',
      title_si: null,
      title_highlight_si: null,
      description: 'Complete your training and receive three industry-recognized credentials that open doors to local and international employment.',
      description_si: null,
